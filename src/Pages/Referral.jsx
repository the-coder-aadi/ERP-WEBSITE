...
/>
  ...
  required
  className={`w-full bg-white border-2 rounded-xl px-4 py-2 duration-200 focus:border-[#8c00ff30] text-[#666666] text-md font-semibold outline-none transition-all placeholder:text-gray-300 placeholder:font-normal
  ${errors.clientMobile ? "border-red-400" : "border-gray-200"}`}
/>
                  </div>
                </div>
  ...
  required
  className={`w-full bg-white border-2 rounded-xl px-4 py-2 duration-200 focus:border-[#8c00ff30] text-[#666666] text-md font-semibold outline-none transition-all placeholder:text-gray-300 placeholder:font-normal
  ${errors.clientEmail ? "border-red-400" : "border-gray-200"}`}
/>
                  </div>
                </div>
              </div>
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-[13px] sm:text-sm font-bold opacity-90 mt-1.5 leading-tight sm:leading-relaxed">
          Your Referral is received. <br className="hidden sm:block" /> 
